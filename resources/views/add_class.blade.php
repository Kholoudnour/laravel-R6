      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('class.store')}}" method="POST" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="time"  placeholder="Enter price" class="form-control py-2"name="timefrom" />
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">Timeto:</label>
            <div class="col-md-10">
              <input type="time"  placeholder="Enter price" class="form-control py-2"name="timeto" />
            </div>
          </div>
