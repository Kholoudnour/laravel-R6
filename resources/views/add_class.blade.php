      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('class.store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">Class:</label>
            <div class="col-md-10">
              <input type="text" placeholder="Class Name" class="form-control py-2" name="classname" value="{{old('classname')}}"/>
              @error ('classname')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <textarea id="" cols="30" rows="5" class="form-control py-2" name="capacity"> {{old('capacity')}}</textarea>
              @error ('capacity')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
