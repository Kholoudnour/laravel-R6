  ...
  <main>
    <div class="container my-5">
      <div class="bg-light p-5 rounded">
        ...
        <form action="<?php echo e(route('cars.store')); ?>" method="POST" class="px-md-5">
          <?php echo csrf_field(); ?>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel-R6/resources/views/add_car.blade.php ENDPATH**/ ?>